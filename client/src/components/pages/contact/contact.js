    ...
    <div className={styles.Contact}>
      ...
      <div className={styles.form}>
        <form action="" method="post">
          ...
          <p className={styles.form__box}>
            <label className={styles.form__label} for="topic">Temat:</label>
            <input className={styles.form__input}
              type="text"
              name="topic"
              id="topic"
          ...
          <p className={styles.form__box}>
            <label className={styles.form__label} for="phone">Numer telefonu:</label>
            <input className={styles.form__input}
              type="phone"
              name="phone"
              id="phone"
          ...
          <p className={styles.form__box}>
            <label className={styles.form__label} for="textArea">Treść wiadomości:</label>
            <textarea className={styles.form__input} id="textArea" name="textArea" rows="5" cols="20">
              Wypisz treść...
            </textarea>
          </p>
          <p className={styles.form__box}>
            <label className={styles.form__label} for="checkbox">Wyślij kopie wiadomości do mnie </label>
            <input type="checkbox" id="checkbox" name="checkbox"></input>
          </p>
          <button className={styles.form__button} type="submit">Wyślij</button>
        </form>
      </div>
    </div>
  </div>
